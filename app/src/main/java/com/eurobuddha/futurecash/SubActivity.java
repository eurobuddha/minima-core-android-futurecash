...
public abstract class SubActivity extends AppCompatActivity {
    ...
    protected EditText input(String hint, int inputType) {
        ...
        e.setHint(hint);
        e.setHintTextColor(FcDesign.DIM_2);
        e.setTextColor(FcDesign.TEXT);
        e.setTextSize(15f);
        ...
        bg.setStroke(dp(1), FcDesign.BORDER_DARK);
        e.setBackground(bg);
        form.addView(e);
        return e;
    }
    ...
    protected TextView primaryButton(String text) {
        ...
        b.setText(text);
        b.setTextColor(FcDesign.ON_YELLOW);
        b.setTextSize(16f);
        b.setTypeface(Typeface.DEFAULT_BOLD);
        b.setGravity(android.view.Gravity.CENTER);
        b.setPadding(0, dp(15), 0, dp(15));
        GradientDrawable bg = new GradientDrawable();
        bg.setColor(FcDesign.YELLOW);
    ...
    protected void setStatus(TextView t, String msg, boolean ok) {
        ...
        t.setText(msg);
        t.setTextColor(ok ? FcDesign.GREEN : FcDesign.RED);
    }
